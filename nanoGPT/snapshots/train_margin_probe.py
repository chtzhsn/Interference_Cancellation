...
ic_lambda_base = 0.5
ic_lambda_mit = 1.0
ic_lambda_margin = 0.5
ic_margin_target = 0.2
...
model_args = dict(
    ...
    ic_lambda_mit=ic_lambda_mit,
    ic_lambda_margin=ic_lambda_margin,
    ic_margin_target=ic_margin_target,
)
if init_from == 'scratch':
    ...
    for k in [
        ...
        'use_ic', 'ic_hidden_dim', 'ic_lambda_base', 'ic_lambda_mit',
        'ic_lambda_margin', 'ic_margin_target'
    ]:
